...
gset <- readRDS("/gpfs/data/kline-lab/inputs/gset_ids_complete_4.rds")
...
# write out results
saveRDS(gs_es, "/gpfs/data/kline-lab/tcga_macs/output/dlbcl_total_immune_gset_v4_results.rds")
