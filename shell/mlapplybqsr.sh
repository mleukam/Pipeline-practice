## This script runs a the second of a two-stage process called Base Quality Score Recalibration (BQSR).
## It then outputs a recalibrated BAM or CRAM file.
## Input is aligned BAM files with duplicates marked and a BQSR table
## Outputs a recalibrated BAM
## Usage = ./mlapplybqsr.sh inside PBS script
